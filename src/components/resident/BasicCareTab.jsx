...
export default function BasicCareTab({ residentId, canEdit }) {
  ...
  const residentBasicCare = basicCare.filter(c => c.residentId === residentId);
  ...
  const handleSubmit = (e) => {
    ...
    const careData = {
      residentId, ...formData,
      ...(todaysCare ? { updatedBy: userName, updatedAt: new Date().toISOString() } : { createdBy: userName, createdAt: new Date().toISOString() })
    };
