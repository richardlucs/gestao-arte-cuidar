...
export default function NursingCareTab({ residentId, canEdit }) {
  ...
  const residentCarePlans = nursingCare.filter(c => c.residentId === residentId && c.recurring);
  ...
  const handleSubmit = (e) => {
    ...
    addNursingCare({ residentId, ...formData, createdBy: userName, createdAt: new Date().toISOString() });
